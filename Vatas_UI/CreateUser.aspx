                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtConfirmPassword" runat="server" class="form-control" placeholder="Confirm Password" TextMode="Password" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtMobileNumber" runat="server" class="form-control" placeholder="Mobile Number" />
                        ...
                        <div class="box-footer">
                            ...
                            <asp:Button ID="btnSubmit" CssClass="btn btn-info pull-right" runat="server" Text="Submit" OnClick="btnSubmit_Click" ValidationGroup="CreateUser" />
                        </div>
                    </div>
                    <div class="box-footer">
                    </div>
