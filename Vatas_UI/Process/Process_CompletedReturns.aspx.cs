    ...
    public partial class Process_CompletedReturns : VatasWebPage
    {
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (this.IsValid)
            {
                ...
                var frontOfcList = DataProviderWrapper.Instance.GetReturnsByJobStatus("UPD", PageNumber, PageSize);
                ...
                {
                    BLFunction.ShowAlert(this, "Returns has been Completed.", result.Response);
                }
                else
                {
                    BLFunction.ShowAlert(this, "Error !!! Returns can not Completed.", result.Response);
                }
            }
            else
            {
        ...
        public void Export()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_Process_CompletedReturn.csv";
        ...
        public void ExportToPdf()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_Process_CompletedReturn.pdf";
            ...
            Paragraph p = new Paragraph("Process - Completed Return", boldFont);
