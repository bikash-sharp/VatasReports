...
{
    public partial class Return_Completed : VatasWebPage
    {
        string JobStatus = "DEC";
        char IsSent;
        ...
        public void Export()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_ReturnsCompleted.csv";
        ...
        public void ExportToPdf()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_ReturnsCompleted.pdf";
            ...
            Paragraph p = new Paragraph("Report - Completed Return", boldFont);
