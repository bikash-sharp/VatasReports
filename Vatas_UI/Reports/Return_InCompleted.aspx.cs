...
{
    public partial class Return_InCompleted : VatasWebPage
    {
        string JobStatus = "DEP";
        char IsSent;
        ...
        public void Export()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_ReturnsInCompleted.csv";
        ...
        public void ExportToPdf()
        {
            ...
            string fileName = DateTime.Now.Date.ToString("MM/dd/yyyy") + "_ReturnsInCompleted.pdf";
            ...
            Paragraph p = new Paragraph("Report - InCompleted Return", boldFont);
