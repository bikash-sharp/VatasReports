...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceBody" runat="server">
    <section class="content-header">
        ...
        <h1>View Users</h1>
        <% } %>
         <% if (Vatas_Common.BLFunction.GetRoleName().ToLower() == "superadmin")
             { %>
        ...
        <ol class="breadcrumb">
            ...
            <% if (Vatas_Common.BLFunction.GetRoleName().ToLower() == "superadmin")
                { %>
            <li><a href="javascript:;">Customer Document</a></li>
            <% } %>
        </ol>
    </section>
        ...
        <div class="box">
            ...
            <asp:Panel ID="pnl" runat="server" DefaultButton="btnSearch">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <asp:Button ID="btnUploadDocument" Text="Upload New Document" OnClick="btnUploadDocument_Click" CssClass="btn btn-info submit" runat="server" />
                        </div>
